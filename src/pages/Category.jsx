...
import { addCategory, getallCategories ,deleteCategory, getVideos, updateCategory} from '../services/allapi';
...
function Category() {
  ...
  const handlaAddCategory=async(e)=>{
  ...
  const handleDeletecategory=async(e,id)=>{
    // automatic reload is terminate
    e.preventDefault()
    console.log(id);
   await deleteCategory(id)

  //  display other category list
   getcategoryList()
  }
    ...
    <>
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button onClick={handlaAddCategory} variant="primary">Add</Button>
        </Modal.Footer>
      </Modal>
